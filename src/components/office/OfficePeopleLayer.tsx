        ...
        return (
          ...
          >
            ...
            {person.posture !== "seated" && (
              <span className="max-w-[62px] truncate text-[8px] font-semibold leading-tight">
                {person.name.split(" ")[0]}
              </span>
            )}
            {person.posture !== "seated" && person.caption && (
              <span className="max-w-[62px] truncate text-[7px] leading-tight text-muted-foreground">
                {person.caption}
              </span>
            )}
          </div>
