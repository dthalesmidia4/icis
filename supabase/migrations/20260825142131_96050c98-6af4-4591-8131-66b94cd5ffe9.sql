-- Guards de integridade dos ciphertexts financeiros (idempotente).
...
-- Nome com prefixo 00_ garante execução antes dos triggers de cifragem.
...
-- Health check que força efetivamente cada decrypt (count(expr) avalia expr).
